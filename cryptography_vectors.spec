...
%prep
%setup -q -n cryptography_vectors-36.0.0
cd %{_builddir}/cryptography_vectors-36.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637599564
...
cp %{_builddir}/cryptography_vectors-36.0.0/LICENSE.APACHE %{buildroot}/usr/share/package-licenses/cryptography_vectors/de33ead2bee64352544ce0aa9e410c0c44fdf7d9
cp %{_builddir}/cryptography_vectors-36.0.0/LICENSE.BSD %{buildroot}/usr/share/package-licenses/cryptography_vectors/ea5b412c09f3b29ba1d81a61b878c5c16ffe69d8
